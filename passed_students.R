library(readxl)
dataset <- read_excel("C:/Users/ijdoc/Desktop/R_Directory/combinedData.xlsx")
dataset
...
library(openxlsx)
write.xlsx(passed_stud,"C:/Users/ijdoc/Desktop/R_Directory/AlisonProjects/passed_students.xlsx")
getwd()
